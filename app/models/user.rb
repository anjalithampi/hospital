class User < ApplicationRecord
  ...
  validates :gender, presence: true, inclusion: { in: [ "Male", "Female" ], message: "is not valid" }, allow_blank: true
  validates :hair_colour, inclusion: { in: [ "Black", "White", "Brown", "Red", "Green", "Blond", "Ginger" ], message: "is not valid" }, allow_blank: true
end
